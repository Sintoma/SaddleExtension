...
\begin{abstract}
In this paper we prove the uniqueness of the saddle-shaped solution $u\colon \R^{2m} \to \R$ to the semilinear nonlocal elliptic equation $\fraclaplacian u = f(u)$ in $\R^{2m}$, where $\s \in (0,1)$ and $f$ is of Allen-Cahn type. Moreover, we prove that this solution is stable if $2m\geq 14$. As a consequence of this result and the connection of the problem with nonlocal minimal surfaces, we show that the Simons cone $\setcond{(x', x'') \in \R^{m}\times \R^m}{|x'| = |x''|}$ is a stable nonlocal $(2\s)$-minimal surface in dimensions $2m\geq 14$.
...
\RMIauthor{Alberti, G., Bouchitt\'e, G. and Seppecher, P.}
...
\RMIjournal{J. Amer. Math. Soc.} {\bf 13} (2000), 725--739.



\bibitem{BerestyckiCaffarelliNiremberg-Qualitative}
\RMIauthor{Berestycki, H., Caffarelli, L. and Nirenberg, L.}
...
\RMIauthor{Berestycki, H., Nirenberg, L. and Varadhan, S.~R.~S.}
...
\bibitem{BogdanEtAl}
\RMIauthor{Bogdan, K., Grzywny, T. and Ryznar, M.}
...
\RMIauthor{Bombieri, E., De Giorgi, E. and Giusti, E.}
...
\RMIauthor{Cabr\'e, X., Cinti, E. and Serra, J.}
...
\RMIjournal{Ann. Inst. H. Poincar\'e Anal. Non Lin\'eaire} {\bf 31} (2014), 23--53.
...
\bibitem{ChanLiuWei}
\RMIauthor{Chan, H., Liu, Y. and Wei, J.}
...
\RMIauthor{Dang, H., Fife, P.~C. and Peletier, L.~A.}
...
\RMIauthor{D{\'a}vila, J., del Pino, M. and Wei, J.}
...
\RMIauthor{del Pino, M., Kowalczyk, M. and Wei, J.}
...
\RMIauthor{Dipierro, S., Farina, A. and Valdinoci, E.}
\RMIpaper{A three-dimensional symmetry result for a phase transition equation in the genuinely nonlocal regime}
\RMIjournal{Calc. Var. Partial Differential Equations} \textbf{57} (2018) Art. 15, 21.



\bibitem{DipierroSerraValdinoci}
\RMIauthor{Dipierro, S., Serra, J. and Valdinoci, E.}
...
\bibitem{LiuWangWei}
\RMIauthor{Liu, Y., Wang, K. and Wei, J.}
