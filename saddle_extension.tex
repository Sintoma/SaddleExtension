...
$$
for which the Simons cone becomes $\mathscr{C} = \{s=t\}$. Through the paper we will also use the letter $\ocal$ to denote one the sets in which the cone divides the space:
$$
